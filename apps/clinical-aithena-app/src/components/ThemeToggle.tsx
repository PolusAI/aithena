...
const ThemeToggle: React.FC<ThemeToggleProps> = ({ className = '' }) => {
    ...
    // Note: setState in useEffect is intentional here for theme initialization
    ...
    return (
        <motion.button
            onClick={toggleTheme}
            className={`relative p-2.5 rounded-xl bg-gray-100 dark:bg-[#1a2744] hover:bg-gray-200 dark:hover:bg-[#2a3f5e] border border-gray-200/50 dark:border-gray-800/50 shadow-sm focus:outline-none cursor-pointer ${className}`}
